...
class AppColors{
  ...
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      ...
      ), colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.grey).copyWith(background: isDarkTheme ? Color(0xFF1a1a2e) : Color(0xfff8f8f8)), textSelectionTheme: TextSelectionThemeData(selectionColor: Color(
        0xFFB71E1E))
    );
