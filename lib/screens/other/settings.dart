          ...
          child: SingleChildScrollView(
              child:Column(
                children: [
                  ...
                  buildSettingItem("Report bugs and help".tr(),LineIcons.questionCircle,(){
                  ...
                  buildSettingItem("Privacy policy".tr(),LineIcons.lock,(){
                    Route route = MaterialPageRoute(builder: (context) => PrivacyPolicy());
                    Navigator.push(context, route);
                  }),
                  buildInfoItem("App version".tr(),LineIcons.infoCircle,projectVersion),
                ],
              )
