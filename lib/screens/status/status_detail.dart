...
class _StatusDetailState extends ResumableState<StatusDetail> {
            ...
            SafeArea(
              child: Column(
                ...
                children: [
                  Expanded(
                    child: Hero(
                      tag: "image_hero_".tr()+widget.status.id.toString(),
                      child:Center(
                            ...
                            child: InkWell(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    widget.status.likes.toString()+ " Likes".tr(),
                                    style: TextStyle(
                                        color:Colors.white70,
                            ...
                            child: InkWell(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    widget.status.comments.toString()+" Comments".tr(),
                                    style: TextStyle(
                                        color:Colors.white70,
                                        fontWeight: FontWeight.w600,
                                        fontSize: 12
  ...
  _shareVideo() async {
    ...
    await Share.shareFiles([savePath], text: widget.status.description +" video".tr());
    setState(() {
      state =null;
      if(widget.back == false)
    ...
    final result = await ImageGallerySaver.saveFile(savePath);
      setState(() {
        ...
        Fluttertoast.showToast(
          msg:"Your video has been downloaded successfully !".tr(),
